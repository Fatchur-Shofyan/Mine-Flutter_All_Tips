...
class _Timeline2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    List<_TimelineStatus> data = [_TimelineStatus.done, _TimelineStatus.inProgress, _TimelineStatus.inProgress, _TimelineStatus.todo];
        ...
        builder: TimelineTileBuilder.connected(
          ...
          connectorBuilder: (_, index, connectorType) {
            ...
            if (index + 1 < data.length - 1) {
              color = data[index].isInProgress && data[index + 1].isInProgress ? const Color(0xff193fcc) : null;
            }
        ...
        builder: TimelineTileBuilder.connected(
          indicatorBuilder: (context, index) {
            ...
            return OutlinedDotIndicator(
              color: status.isInProgress ? const Color(0xff6ad192) : const Color(0xffe6e7e9),
              backgroundColor: status.isInProgress ? const Color(0xffd4f5d6) : const Color(0xffc2c5c9),
